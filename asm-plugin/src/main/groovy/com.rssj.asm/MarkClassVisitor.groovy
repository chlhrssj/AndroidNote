...
//    private HashMap<String, MkAnalyticsMethodCell> mLambdaMethodCells = new HashMap<>()
    ...
    void visit(int version, int access, String name, String signature, String superName, String[] interfaces) {
        ...
        if (superName != null && (superName.contains(superActivity) || superName.contains(superFragment))) {
    ...
    MethodVisitor visitMethod(int access, String name, String desc, String signature, String[] exceptions) {
        if (currentSuperClassName != null && (currentSuperClassName.contains(superActivity) || currentSuperClassName.contains(superFragment))) {
